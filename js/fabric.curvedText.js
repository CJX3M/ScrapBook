...
//    * @return value of param, or false if unknown
//    */
//    CurvedText.prototype.getTextParam = function( param ) {
//      this._render();
//      if ( this.optsText[param] !== undefined ) {
//        return this.optsText[param];
//      } else {
//        return false;
//      }
//    };
...
//    * @return {object} value of every text options
//    */
//    CurvedText.prototype.getTextParams = function() {
//      this._render();
//      return this.optsText;
//    };
//    
//    /**
...
//    */
//    CurvedText.prototype.setText = function( newText, params ) {
//
...
//        }
//        if (params !== undefined) {
//            this._verifyTextOptions(params);            
//        }
//        this.optsText.text = newText;
//        this._setFontStyles();
//        this._render();
//    };
//    
...
//            this.group.item(i).set( this.optsText );
//        }
//    };
//
//    /**
...
//
//    /**
//    * @method _verifyOptions
//    * @param options
//    */
//    CurvedText.prototype._verifyOptions = function(options) {
//        // Options
//        this.opts = options || {};
...
//    
//    /**
//    * @method _verifyTextOptions
//    * @param options
//    */
//    CurvedText.prototype._verifyTextOptions = function(options) {
//        // Options Text
//        this.optsText = options || {};
//        for ( var prop in CurvedText.defaultText ) {
//            if (prop in this.optsText) { continue; }
//            this.optsText[prop] = CurvedText.defaultText[prop];
//        }
//    }
//
//    /**
		...
		setText: function(text, params) {
			if(this.letters){
				...
				for(var i=0; i<text.length; i++){
                    ...
                    if (params !== undefined)
                        this.letters.item(i).set(params);
				}
			}
